export const pt = {
  ...
  dashboard: {
    ...
    actionItems: 'Itens que Precisam de Atenção',
    actionItemsAllClear: 'Tudo em dia!',
    actionItemsNone: 'Nenhum item crítico pendente no momento.',
  ...
  activities: {
    ...
    updatedRisk: 'Risco atualizado',
    newControl: 'Novo controle implementado',
    updatedControl: 'Controle atualizado',
    documentAdded: 'Documento adicionado',
    documentUpdated: 'Documento atualizado',
    newAudit: 'Nova auditoria iniciada',
    updatedAudit: 'Auditoria atualizada',
    newComplaint: 'Nova denúncia recebida',
    updatedComplaint: 'Denúncia atualizada',
    newIncident: 'Novo incidente registrado',
    updatedIncident: 'Incidente atualizado',
    newActionPlan: 'Novo plano de ação criado',
    updatedActionPlan: 'Plano de ação atualizado',
  },
  modules: {
    // Riscos
    riscos: {
      ...
      high: 'Altos',
      treated: 'Tratados',
      pendingApproval: 'Pendentes Aprovação',
      accepted: 'Aceitos',
    ...
    licencas: {
      ...
      total: 'Total de Licenças',
      totalDesc: 'Licenças registradas',
      active: 'Licenças Ativas',
      activeDesc: 'Em vigor',
      expiring: 'A Vencer',
      expiringDesc: 'Próximos 30 dias',
      expired: 'Vencidas',
      expiredDesc: 'Expiradas',
    },
    // Chaves
    chaves: {
    ...
    continuidade: {
      ...
      description: 'Gerencie planos de continuidade, tarefas e testes',
      newPlan: 'Novo Plano',
    ...
    governanca: {
      title: 'Governança',
      controlsTitle: 'Controles Internos',
      controlsDesc: 'Gerencie os controles internos da organização',
      auditsTitle: 'Auditorias',
      auditsDesc: 'Gerencie auditorias e acompanhe evidências',
      controls: 'Controles',
      audits: 'Auditorias',
    ...
    gapAnalysis: {
      title: 'Gap Analysis',
      description: 'Avalie a aderência da organização aos principais frameworks de mercado',
      frameworks: 'Frameworks',
      newFramework: 'Adicionar Framework',
