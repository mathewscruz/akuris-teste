...
import { Plus, Search, AlertTriangle, TrendingUp, CheckCircle, Shield } from 'lucide-react';
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-muted-foreground">Carregando riscos...</div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Status dos Tratamentos</CardTitle>
            <TrendingUp className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{stats.tratamentos_concluidos}</div>
            <div className="text-xs text-muted-foreground mt-1">
              Pendentes: {stats.tratamentos_pendentes} | Em andamento: {stats.tratamentos_andamento}
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-xs text-muted-foreground mt-1">
              Aceitos formalmente sem tratamento
            </div>
          </CardContent>
        </Card>
