...
interface CompanyContextDialogProps {
  open: boolean;
...
export function CompanyContextDialog({ open, onOpenChange }: CompanyContextDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        ...
        <p className="text-sm text-muted-foreground">
          Essas informações personalizam as orientações da IA para o setor e porte da sua empresa.
        </p>
