-- Corrigir TODAS as perguntas de Due Diligence restantes - versão corrigida
...
-- 4. Ajustar perguntas que pedem valores numéricos para textarea (campo de texto longo)
UPDATE public.due_diligence_questions 
SET 
  tipo = 'textarea',
  opcoes = NULL,
